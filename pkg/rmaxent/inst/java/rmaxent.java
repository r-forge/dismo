...
//javac -classpath maxent.jar rmaxent.java
//java -cp .;maxent.jar rmaxent
//jar cf rmaxent.jar rmaxent.class

import density.*;

public class rmaxent {

	public static void main(String args[]) {
	}
	
	public double predict1 (String lambda, String[] vars, double[] vals) {
		Evaluate eval=null;
		try {
